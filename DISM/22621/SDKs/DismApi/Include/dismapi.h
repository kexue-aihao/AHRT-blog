...
#define _DismGetProvisionedAppxPackages DismGetProvisionedAppxPackages
#define _DismAddProvisionedAppxPackage DismAddProvisionedAppxPackage
#define _DismRemoveProvisionedAppxPackage DismRemoveProvisionedAppxPackage
